...
Route::middleware(['auth:admin', 'CheckSession'])->group(function () {
    // dd(Auth::guard('admin')->user());
    Route::get('/{admin}/{dashboard}', [AdminController::class, 'dashboardadmin'])
        ->name('admin.dashboard')
        ->where(['admin' => 'manager|admin|bp|superadmin', 'dashboard' => 'dashboard']);

        Route::get('/{admin}/{dashboard}', [AdminController::class, 'dashboardadmin'])->name('mlos.indexadmin');
    Route::get('/{admin}/{dashboard}', [AdminController::class, 'dashboardadmin'])
        ->name('admin.dashboard')
        ->where(['admin' => 'manager|admin|bp', 'dashboard' => 'dashboard']);
});
...
logger()->info('Route admin.dashboardadmin is being registered');
Route::middleware('auth:admin')->group(function () {
    Route::get('/admin/dashboardadmin', function () {
        logger()->info('Route admin.dashboardadmin accessed');
...
Route::post('/{admin}/{dashboard}', [MitraController::class, 'store'])->name('mlos.store');
