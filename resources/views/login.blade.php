    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
      ...
      <div>
        <div class="flex items-center justify-between">
          ...
          <div class="text-sm">
              <a href="#" class="font-semibold text-black hover:text-gray-800">Lupa Password?</a>
          </div>
        </div>
        <div class="mt-2">
      ...
      <div>
        <button type="submit" class="flex w-full justify-center rounded-md bg-black px-3 py-1.5 text-sm/6 font-semibold text-white shadow-sm hover:bg-gray-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black" onclick="window.location.href='/dashboard/dashboardmlo';">Masuk</button>
      </div>
    </form>
