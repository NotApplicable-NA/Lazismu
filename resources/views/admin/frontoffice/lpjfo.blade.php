...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="h-full bg-white">
    <head>
        ...
        <title>LPJ Admin Front Office</title>
        <!-- favicon -->
    ...
    <div class="container py-8 px-4">
            ...
            <div class="card shadow-sm border-0">
                <div class="card-header bg-white d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">LPJ <span class="badge bg-primary">X users</span></h5>
                </div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <div class="inline-flex space-x-4">
                        <!-- read action -->
                        <a href="/frontoffice/lpjdetailfo" class="flex items-center py-2 text-base font-medium text-gray-900 dark:text-white dark:hover:underline">
