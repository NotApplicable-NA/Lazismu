                            ...
                            <div class="card-body p-5">
                                ...
                                <div class="container">
                                    ...
                                    <div class="d-flex justify-content-end">
                                        <button type="button" class="btn btn-primary me-2 px-4 py-2 text-green-500 bg-[rgba(34,197,94,0.2)] border-2 border-green-500 rounded-lg hover:bg-[rgba(34,197,94,0.4)] hover:text-green-700 focus:outline-none focus:ring-2 focus:ring-green-300">
                                            Kirim
                                        </button>
                                        <button type="button" class="btn btn-success px-4 py-2 text-red-500 bg-[rgba(239,68,68,0.2)] border-2 border-red-500 rounded-lg hover:bg-[rgba(239,68,68,0.4)] hover:text-red-700 focus:outline-none focus:ring-2 focus:ring-red-300">
                                            Simpan
                                        </button>
                                    </div>
                                </div>
