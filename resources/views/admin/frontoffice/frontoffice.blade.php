    ...
    <div class="container py-8 px-4">
            <!-- Header -->
                <header class="mb-4 mt-5">
                    <h1 class="fw-bold fs-5">Front Office</h1>
            ...
            <tbody>
                <tr class= "bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <div class="inline-flex space-x-4">
                        <!-- read action -->
                        <a href="/frontoffice/frontofficedetail" class="flex items-center py-2 text-base font-medium text-gray-900 dark:text-white dark:hover:underline">
