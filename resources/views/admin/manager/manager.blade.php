...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="h-full bg-white">
    <head>
        ...
        <title>Proposal Admin Manager</title>
        <!-- favicon -->
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <div class="inline-flex space-x-4">
                        <!-- read action -->
                        <a href="/manager/managerdetail" class="flex items-center py-2 text-base font-medium text-gray-900 dark:text-white dark:hover:underline">
