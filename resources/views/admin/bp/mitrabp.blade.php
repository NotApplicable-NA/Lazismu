...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="h-full bg-white">
    <head>
        ...
        <title>Mitra Badan Pengurus</title>
        <!-- favicon -->
            ...
            <tbody>
                ...
                <tr class= "bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <div class="inline-flex space-x-4">
                        <!-- detail action -->
                        <a href="/program/mitradetailprogram" class="flex items-center py-2 text-base font-medium text-gray-900 dark:text-white dark:hover:underline">
