          ...
          <div class="flex items-center ms-3">
              ...
              <div class="hidden z-50 my-4 w-56 text-base list-none bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600" id="dropdown">
                <div class="py-3 px-4">
                    ...
                    <?php if(Auth::guard('admin')->check()): ?>
                        ...
                        <span class="block text-sm font-semibold text-gray-900 dark:text-black">
                            <?php echo e(Auth::guard('admin')->user()->nama ?? 'Admin'); ?>

                        </span>
                        <span class="block text-sm text-gray-500 truncate dark:text-gray-400">
                            <?php echo e(Auth::guard('admin')->user()->email ?? 'admin@example.com'); ?>

                        </span>
                    <?php elseif(Auth::guard('mitras')->check()): ?>
                        <!-- Untuk Mitras -->
                        <span class="block text-sm font-semibold text-gray-900 dark:text-black">
                            <?php echo e(Auth::guard('mitras')->user()->nama ?? 'Mitra'); ?>

                        </span>
                        <span class="block text-sm text-gray-500 truncate dark:text-gray-400">
                            <?php echo e(Auth::guard('mitras')->user()->email ?? 'mitra@example.com'); ?>
                ...
                <ul class="py-1 text-gray-500 dark:text-gray-400" aria-labelledby="dropdown">
                    <li>
                        <form method="POST" action="<?php echo e(Auth::guard('admin')->check() ? route('admin.logout') : route('mitras.logout')); ?>">
                            <?php echo csrf_field(); ?>
...
</html><?php /**PATH D:\laragon\www\Lazismu\resources\views/layouts/sidebaradmin.blade.php ENDPATH**/ ?>