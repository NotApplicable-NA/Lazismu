...
<?php endif; ?>
    ...
    <form class="space-y-6" action="<?php echo e(route('mitra.login')); ?>" method="POST">
    <?php echo csrf_field(); ?>
        <div>
      ...
      <div>
        <div class="flex items-center justify-between">
          ...
          <div class="text-sm">
              <a href="/forgot-password" class="font-semibold text-black hover:text-gray-800">Lupa Password?</a>
          </div>
        </div>
        <div class="mt-2">
...
<?php /**PATH D:\laragon\www\Lazismu\resources\views/login.blade.php ENDPATH**/ ?>