...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>" class="h-full bg-white">
  ...
  <nav class="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
    ...
    <li>
        <button href="/dashboard/proposal" id="dropdownNavbarLink" data-dropdown-toggle="dropdownNavbar" class="flex items-center justify-between w-full py-2 px-3 text-black rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 md:w-auto dark:text-white md:dark:hover:text-blue-500 dark:focus:text-white dark:border-gray-700 dark:hover:bg-gray-700 md:dark:hover:bg-transparent" onclick="window.location.href='/dashboard/proposal';">
            Proposal
              ...
              <div class="hidden z-50 my-4 w-56 text-base list-none bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600" id="dropdown">
                  <div class="py-3 px-4">
                      <span class="block text-sm font-semibold text-gray-900 dark:text-black"><?php echo e(Auth::user()->nama ?? 'Guest'); ?></span>
                      <span class="block text-sm text-gray-500 truncate dark:text-gray-400"><?php echo e(Auth::user()->email ?? 'guest@example.com'); ?></span>
                  </div>
...
<?php /**PATH D:\laragon\www\Lazismu\resources\views/layouts/navbarMLO.blade.php ENDPATH**/ ?>