...
<div class="flex justify-center py-4 space-x-4"> <!-- Memposisikan card di tengah dan memberikan padding atas-bawah -->
    <div class="max-w-2xl p-6 bg-white border border-gray-200 rounded-lg shadow-lg flex items-start space-x-4">
        ...
        <div class="flex flex-col">
            ...
            <p class="text-gray-700">Hai <?php echo e(Auth::user()->nama ?? 'Guest'); ?>, Selamat datang di sistem Pelayanan lazismu daerah istimewa yogyakarta.</p>
        </div>
    </div>
</div>
...
<div class="flex justify-center items-center p-8 min-h-screen">
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg bg-white dark:bg-gray-800 p-4">
        ...
        <!-- read action -->
        <a href="/detailpengajuan" class="flex items-center py-2 text-base font-medium text-gray-900 bg-gray-50 hover:bg-gray-100 dark:bg-gray-700 dark:text-white dark:hover:underline">
            <img src="/img/read_action.png" alt="Read action" class="w-5 h-5" />
        </a>
        <!-- edit action -->
        <a href="/editpengajuan" class="flex items-center py-2 text-base font-medium text-gray-900 bg-gray-50 hover:bg-gray-100 dark:bg-gray-700 dark:text-white dark:hover:underline">
...
<?php /**PATH D:\laragon\www\Lazismu\resources\views/dashboard/dashboardmlo.blade.php ENDPATH**/ ?>